...
from content_factory.generation.utils.validation_cache import ValidationCache
from content_factory.generation.validators.rubric.scorer import RubricScorer
...
def test_rubric_cache_depends_on_learning_outcomes(monkeypatch, mock_llm_client):
    ...
    monkeypatch.setattr("content_factory.generation.validators.rubric.scorer.get_cache", lambda: local_cache)
