...
from content_factory.api.routers.health import router
...
class TestHealthCheck:
    ...
    @patch('content_factory.api.routers.health.get_database_status')
    @patch('content_factory.api.routers.health.check_database_connection')
    @patch('content_factory.api.routers.health.psutil.Process')
    ...
    def test_health_check_db_error(self, mock_check_db, mock_db_status, client, mock_db):
        ...
        with patch('content_factory.api.routers.health.psutil.Process'):
            response = client.get("/health")
