from content_factory.generation.agents.practice_prompting import build_practice_sjm_section
from content_factory.generation.agents.theory_prompting import build_theory_sjm_section
