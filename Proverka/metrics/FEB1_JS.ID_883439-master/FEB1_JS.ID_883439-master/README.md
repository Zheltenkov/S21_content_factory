...
2. Все файлы с кодом необходимо создавать в папке *src/* склонированного репозитория.
...
atm(8350); // { '50': 1,'100': 1,'200': 1,'500': 0,'1000': 1,'2000': 1,'5000': 1 }
...
И финальное задание в этом проекта. Оно является бонусным и приносит дополнительную XP. Здесь тебе понадобятся знания, полученные в ходе изучения тем и выполенения предыдущих заданий.
