...
from content_factory.api.db.generation_results_db import (
    get_generation_result,
    get_report_by_request_id,
)
from content_factory.api.dependencies import get_current_user
from content_factory.api.services.archive_builder import (
    add_assets_to_zip,
...
async def download_template():
    ...
    """
    try:
        from content_factory.utils.excel_io import excel_template
