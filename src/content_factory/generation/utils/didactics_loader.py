...
logger = logging.getLogger("content_factory.generation.utils.didactics_loader")
...
def compose_didactics_context(config_name: str) -> tuple[str, dict[str, Any]]:
    try:
        from content_factory.generation.didactics.composer import compose_didactics_context as _compose
