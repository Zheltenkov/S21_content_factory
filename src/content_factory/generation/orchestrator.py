...
logger = logging.getLogger("content_factory.generation.orchestrator")
...
class Orchestrator:
    ...
    def _log_phase_to_db(self, phase: str, message: str = ""):
        ...
        """
        try:
            from content_factory.api.db.logging_db import write_log
            from content_factory.api.db.session import SessionLocal
            from content_factory.api.utils.logging_context import get_request_id, get_user_id
