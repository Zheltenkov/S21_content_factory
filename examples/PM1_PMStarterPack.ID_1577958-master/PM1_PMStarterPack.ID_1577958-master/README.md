...
## Содержание
  ...
  - [Chapter II](#chapter-ii)
    - [Задание 1. Роли в команде](#задание-1-роли-в-команде)
    - [Задание 2. Классификация продукта и выбор фичи](#задание-2-классификация-продукта-и-выбор-фичи)
    - [Задание 3. Жизненный цикл продукта](#задание-3-жизненный-цикл-продукта)
    - [Задание 4. Первый бэклог](#задание-4-первый-бэклог)
    - [Задание 5. Фиксация договоренностей](#задание-5-фиксация-договоренностей)
...
| _Streak (ударный режим) — это система мотивации, популярная в приложениях для изучения языков (как [Duolingo](https://ru.duolingo.com/help/what-is-a-streak)), где огонек (🔥) показывает, сколько дней подряд вы выполняете хотя бы одно задание, помогая формировать привычку и закреплять знания. Streak длится, пока вы занимаетесь каждый день, и его потеря мотивирует продолжать, даже в трудных обстоятельствах, чтобы не прерывать цепочку.<br><br>Как это работает (на примере Duolingo):<br><br>1. Занимайтесь каждый день:выполняйте хотя бы один урок, чтобы ваш streak продолжился<br>2. Значок пламени (🔥) показывает количество дней подряд.<br>3. Мотивация: поддерживает постоянную практику, которая важна для изучения языка.<br>4. Напоминания: можно настроить уведомления в приложении, чтобы не забывать заниматься._ |
| - |

![duo](misc/images/duo.png)

Источник: https://blog.duolingo.com/improving-the-streak/
...
<br/>_Пример заполнения_

![table1](misc/images/table1.png)
...
1. Составить схему жизненного цикла твоего продукта:
    - Создай доску в Miro с названием, связанным с твоим проектом (или другом аналоге, в т. ч. и отечественном, например, Holst), и нарисуй схему жизненного цикла продукта с этапами: 
        Idea —> MVP/MLP —> Scaling —> Support
