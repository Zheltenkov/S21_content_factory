...
from api.db.session import get_database_status, init_db, should_auto_create_tables
from api.integrations.auth_cookie import ToolAuthCookieMiddleware
from api.integrations.spravochnik_mount import build_spravochnik_app
...
async def startup_event():
    ...
    async def periodic_log_cleanup():
        ...
        from api.db.maintenance_db import cleanup_old_runtime_state_async
