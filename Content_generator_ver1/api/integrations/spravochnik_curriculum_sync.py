...
from api.db.models import SpravochnikCatalogEntity, utc_now_naive
from api.db.session import SessionLocal
from api.integrations.project_paths import ensure_import_path, spravochnik_root, spravochnik_sqlite_path
from content_gen.models.curriculum import CurriculumPlan, CurriculumProject, ThematicBlock

logger = logging.getLogger("api.integrations.spravochnik_curriculum_sync")
