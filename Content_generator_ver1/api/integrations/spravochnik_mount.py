...
from api.integrations.project_paths import (
    ensure_import_path,
    spravochnik_root,
    spravochnik_sqlite_path,
    spravochnik_summary_path,
)
from api.integrations.spravochnik_curriculum_sync import sync_spravochnik_curriculum_plans

logger = logging.getLogger("api.integrations.spravochnik_mount")
