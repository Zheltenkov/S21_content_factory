...
def test_curriculum_router_exposes_persisted_plan_routes():
    ...
    from api.routers.curriculum import router
...
def test_spravochnik_plan_payload_converts_to_generator_contract():
    ...
    from api.integrations.spravochnik_curriculum_sync import convert_spravochnik_plan_to_generator_curriculum
...
class TestCurriculumModels:
    ...
    def test_curriculum_project_to_summary(self):
        ...
        from content_gen.models.curriculum import CurriculumProject
    ...
    def test_thematic_block_get_all_learning_outcomes(self):
        ...
        from content_gen.models.curriculum import CurriculumProject, ThematicBlock
